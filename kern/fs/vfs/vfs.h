 ...
 *
 * 因为带上一些操作，所以成了文件系统的一个抽象
 * fs_info 表示了一个具体的文件系统 ，ucore中只有 sfs_fs
 */
struct fs {
    union {
 ...
 *
 */
int vfs_open(char *path, uint32_t open_flags, uint32_t arg2, struct inode **inode_store);
